...
/* Fontawesome */
window.FontAwesomeKitConfig = {"asyncLoading":{"enabled":true},"autoA11y":{"enabled":true},"baseUrl":"https://ka-p.fontawesome.com","baseUrlKit":"https://kit.fontawesome.com","detectConflictsUntil":null,"iconUploads":{},"id":83024294,"license":"pro","method":"css","minify":{"enabled":true},"token":"2551a6c49e","uploadsUrl":"https://kit-uploads.fontawesome.com","v4FontFaceShim":{"enabled":true},"v4shim":{"enabled":true},"version":"5.15.3"};
...
/* Staggered onscroll */
!function(i){i.fn.visible=function(l){var o=i(this),e=i(window),n=e.scrollTop(),a=n+e.height(),t=o.offset().top,s=t+o.height();return(!0===l?t:s)<=a&&(!0===l?s:t)>=n}}(jQuery);var win=$(window),allMods=$(".communities-featured-block.scroll-animate-featured"),allProperty=$(".scroll-animate");win.scroll(function(i){allMods.each(function(i,l){(l=$(l)).visible(!0)&&l.addClass("come-in")}),allProperty.each(function(i,l){(l=$(l)).visible(!0)&&l.addClass("come-up")})});
/* Slick */
